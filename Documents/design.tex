...
\begin{center}
  ...
  \begin{tikzpicture}
    ...
    \begin{class}[text width=3cm]{RequestStatus}{-10, -5}
      \attribute{* Waiting}
      \attribute{* Approved}
      \attribute{* Declined}
    \end{class}
    ...
    \begin{class}{GroupList}{4, -3}
      ...
      \attribute{status : GroupListStatus enum}
    \end{class}
    ...
    \begin{class}{GroupRequest}{-3, -1}
    	\attribute{id : Integer (\textbf{PK})}
      	\attribute{userId : Integer (\textbf{FK})}
      	\attribute{groupId : Integer (\textbf{FK})}
      	\attribute{status : GroupRequestStatus enum}
    \end{class}
	...
	\begin{class}[text width=3.5cm]{GroupRequestStatus}{-3, -5}
		\attribute{* Testing}
		\attribute{* TestingSucceeded}
		\attribute{* TestingFailed}
	\end{class} 
	
	\begin{class}[text width=3cm]{GroupListStatus}{10, -5}
		\attribute{* Studing}
		\attribute{* Successed}
		\attribute{* Failed}
    ...
    \association{GroupRequestStatus}{}{}{RequestStatus}{Inheritance}{}
